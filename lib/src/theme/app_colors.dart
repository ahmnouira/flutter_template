...
class AppColors {
  ...
  static const Color grey = Color(0xff999EA1);
  static const Color error = Color(0xffFB344F);
  static const Color textField = Color(0xffF7F8F9);
  static const Color textFieldBorder = Color(0x1A90BC29);
  static const Color checkboxText = Color(0xff000C14);
  static const Color checkboxBorder = Color(0xffCDD1E0);
