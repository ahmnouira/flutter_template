...
class HttpService {
  ...
  dynamic get({required String path, String? token}) => _handler(() async {
  ...
  dynamic post({required String path, required Object? data, String? token}) =>
      _handler(() async {
  ...
  dynamic put({required String path, required Object? data, String? token}) =>
      _handler(() async {
